...
public class MidWay {
    ...
    */
    ...
    /**
       ...
       dissappear whenever remote domains are implemented. 
...
/* flags for mwattach() */
    ...
    static {
    	...
    	path = path + ":/localhome/terje/projects/jMidWay/native";
    	System.out.println("path: " + path);
    	System.setProperty("java.library.path", path);
    	path = System.getProperty("java.library.path");
    	System.out.println("path: " + path);
    	System.loadLibrary("jMidWay");
    }
    ...
    */
    public static native int attach(String name, String url, int flags) throws MidWayException;
    ...
    /**
       ...
       @throws MidWayException 
    */
    public static void attach() throws MidWayException {
        attach(null, null, 0);
    };
    ...
    /**
       ...
       @throws MidWayException 
    */
    public static void attach(String url) throws MidWayException {
        attach(url, null, 0);
    };

    public static void attachServer() throws MidWayException {
        attach(null, null, MidWay.SERVER);
    };

    public static void attachServer(String url) throws MidWayException {
    ...
    */
    public static native String[] listServices(String glob) throws MidWayException ;
    ...
    /** 
        ...
        @return a list of services or null if there are no services matching
    */
    public static String[] listServices() throws MidWayException  {
    ...
    /**
       ...
       @throws MidWayException
     */
    public static CallReply call(String service, byte[] data, int flags) throws MidWayException {
    ...
    public static CallReply call(String service) throws MidWayException {
        return call(service, (byte []) null, 0);
    };

    public static CallReply call(String service, String data, int flags) throws MidWayException {
        return call(service, data.getBytes(), flags);
    };

    public static CallReply call(String service, String data) throws MidWayException {
        return call(service, data.getBytes(), 0);
    };

    public static CallReply call(String service, int flags) throws MidWayException {
    ...
    /**
       ...
       @throws MidWayException
     */
    public static native int acall(String service, byte[] data, int flags) throws MidWayException;

    public static int acall(String service) throws MidWayException {
        return acall(service, (byte [])null, 0);
    };

    public static int acall(String service, String data, int flags) throws MidWayException {
        return acall(service, data.getBytes(), flags);
    };

    public static int acall(String service, String data) throws MidWayException {
        return acall(service, data.getBytes(), 0);
    };

    public static int acall(String service, int flags) throws MidWayException {
    ...
    */
    public static native boolean fetch(int handle, CallReply rpl, int flags) throws MidWayException;
...
//     }
    ...
    public static native int provide(String servicename, ServiceProvider provider) throws MidWayException;
    public static native int unprovide(String servicename, long subscriptionID);
    
    public static native int forward(String service, byte[] reply) throws MidWayException;
    public static native int reply(byte[] reply, int returnCode, int applicationReturnCode) throws MidWayException;

    public static native int doServiceRequest(int flags);

    private Object mainloopmutex = new Object();

    public static void mainServerLoop() throws MidWayException {
        while(true) {
            doServiceRequest(0);
        }
    }
    ...
    public static native int event(String eventname, byte[] data, String username, String clientname);

    public static int event(String eventname, byte[] data) {
        return event(eventname, data, null, null);
    };

    public static int event(String eventname, String data) {
        return event(eventname, data.getBytes(), null, null);
    };

    public static int event(String eventname, String data, String username, String clientname) {
        return event(eventname, data.getBytes(), username, clientname);
    };

    public static int event(String eventname, String username, String clientname) {
        return event(eventname, new byte[0], username, clientname);
    };

    
    public static native int subscribe(String event, IEventListener evl, int flags) throws MidWayException;

    public static int subscribe(String event, IEventListener evl) throws MidWayException {
        return subscribe(event, evl, 0);
    }


    public static native void recvevents();
    ...
    */
    ...
    /**
       ...
       @param message the message to add to the log
    */
    public static void debug4(String msg) {
        log(LOG_DEBUG4, msg);
    }
    ...
    */
     ...
     */
    public static native void openlog(String progname, String fileprefix, int level);
